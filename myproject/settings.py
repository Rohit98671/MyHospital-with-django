...
SECRET_KEY = '7#wulpwi##lr%)(n518*(_r9f6=s_iv5wo^r**^n7x8*sewt$w'
...
EMAIL_HOST_USER = ''
EMAIL_HOST_PASSWORD = ''
EMAIL_USE_TLS = False #These are security stuffs
# EMAIL_USE_SSL = False

# python -m smtpd -n -c DebuggingServer localhost:1025
#this is to activate the email server in terminal
...
because gmail doesn't allow the third party app to send email automatically
